...
1. Средняя и худшая временные сложности: О(n²), где n — длина массива.
2. Лучшая временная сложность тоже О(n²) даже в оптимальном случае.
...
### __Оценка временной сложности:__
1. В худшем случае: O(n), где n — длина массива.
